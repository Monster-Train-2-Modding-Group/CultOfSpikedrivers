...
[![GitHub Release](https://img.shields.io/github/v/release/Monster-Train-2-Modding-Group/CultOfSpikedrivers?color=4CAF50&label=latest)](https://github.com/Monster-Train-2-Modding-Group/CultOfSpikedrivers/releases)
...
* If installed via a Mod Manager. The file can be simply be edited in your mod manager's config editor.

* If installed manually,  the file should be located relative to BepinEx's root folder in the config directory. Example:
  `C:\Program Files (x86)\Steam\steamapps\common\Monster Train 2\BepInEx\config\CultOfSpikedrivers.Plugin.cfg`
...
All assets (except the mod icon) are from Monster Train 1 and are owned by Shiny Shoe.